...
const (
	...
	BtnRoleProvider = "🚕 Haydovchi / Usta"
	BtnRoleClient   = "🔍 Mijoz"

	BtnRoleSwitch = "⚙️ Rolni o‘zgartirish"
	BtnCreateAd   = "➕ E'lon berish"
)
...
func RoleSelectText() string {
	return "Siz kim sifatida foydalanmoqchisiz?"
}
